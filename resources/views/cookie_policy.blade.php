...
@section('meta')
    <title>Cookie policy - AidSpace</title>
    <meta property="og:locale" content="en_US"/>
    <meta property="og:type" content="article"/>
    <meta property="og:title" content="Cookie policy - AidSpace"/>
    <meta property="og:description"
          content="Helping organisations around the world managing their volunteers, communication and work schedules."/>
    <meta property="og:url" content="https://aidspace.io/legal/cookie-policy/"/>
    <meta property="og:site_name" content="AidSpace"/>
    <meta name="twitter:card" content="summary_large_image"/>
    <meta name="twitter:title" content="Cookie policy - AidSpace"/>
...
@section('content')
    {{--<div id="hgr_sections">--}}
        {{--<div id="cookie-policy" class="row standAlonePage">--}}
                                ...
                                {{--<div class="wpb_column vc_column_container vc_col-sm-12">--}}
                                    {{--<div class="vc_column-inner ">--}}
                                        {{--<div class="wpb_wrapper">--}}
                                            {{--<div class="wpb_text_column wpb_content_element  vc_custom_1534500731940">--}}
                                                {{--<div class="wpb_wrapper">--}}
                                    ...
                                    {{--<div class="vc_column-inner ">--}}
                                        {{--<div class="wpb_wrapper">--}}
                                            {{--<div class="wpb_text_column wpb_content_element ">--}}
                                                {{--<div class="wpb_wrapper">--}}
                                                    {{--<p>We use cookies to help improve your experience of <a--}}
                                                            {{--href="https://volunteers.aidspace.io/">https://volunteers.aidspace.io</a>.--}}
                                                        {{--This cookie policy is part of AidSpace IVS&#8217; privacy--}}
                                                        ...
                                                        {{--service, though they are not covered by our policy.</p>--}}
                                                    {{--<p>If you don’t wish to accept cookies from us, you should instruct--}}
                                                        {{--your browser to refuse cookies from <a--}}
                                                            {{--href="https://volunteers.aidspace.io/">https://volunteers.aidspace.io</a>,--}}
                                                        {{--with the understanding that we may be unable to provide you with--}}
                                                        {{--some of your desired content and services.</p>--}}
                                                    {{--<h3>What is a cookie?</h3>--}}
                                                    {{--<p>A cookie is a small piece of data that a website stores on your--}}
                                                        ...
                                                        {{--itself.</p>--}}
                                                    {{--<p>Cookies are used to enable certain features (eg. logging in), to--}}
                                                        {{--track site usage (eg. analytics), to store your user settings--}}
                                                        {{--(eg. timezone, notification preferences), and to personalise--}}
                                                        {{--your content (eg. advertising, language).</p>--}}
                                                    {{--<p>Cookies set by the website you are visiting are normally referred--}}
                                                    ...
                                                    {{--<p>Essential cookies are crucial to your experience of a website,--}}
                                                        {{--enabling core features like user logins, account management,--}}
                                                        {{--shopping carts and payment processing. We use essential cookies--}}
                                                        {{--to enable certain functions on our website.</p>--}}
                                                    {{--<h4>Performance cookies</h4>--}}
                                                    {{--<p>Performance cookies are used in the tracking of how you use a--}}
                                                        {{--website during your visit, without collecting personal--}}
                                                        {{--information about you. Typically, this information is anonymous--}}
                                                        {{--and aggregated with information tracked across all site users,--}}
                                                        {{--to help companies understand visitor usage patterns, identify--}}
                                                        {{--and diagnose problems or errors their users may encounter, and--}}
                                                        {{--make better strategic decisions in improving their audience’s--}}
                                                        {{--overall website experience. These cookies may be set by the--}}
                                                        {{--website you’re visiting (first-party) or by third-party--}}
                                                        {{--services. We use performance cookies on our site.</p>--}}
                                                    {{--<h4>Functionality cookies</h4>--}}
                                                    {{--<p>Functionality cookies are used in collecting information about--}}
                                                        ...
                                                        {{--service. We use functionality cookies for selected features on--}}
                                                        {{--our site.</p>--}}
                                                    {{--<h4>Targeting/advertising cookies</h4>--}}
                                                    {{--<p>Targeting/advertising cookies are used in determining what--}}
                                                        ...
                                                        {{--their campaigns and the quality of content presented to you.--}}
                                                        ...
                                                        {{--websites that use the same third-party service. We do not use--}}
                                                        {{--this type of cookie on our site.</p>--}}
                                                    {{--<h3>Third-party cookies on our site</h3>--}}
                                                    {{--<p>We may employ third-party companies and individuals on our--}}
                                                        ...
                                                        {{--AidSpace IVS&#8217; cookie policy.</p>--}}
                                                    {{--<h4>Our third-party privacy promise</h4>--}}
                                                    {{--<p>We review the privacy policies of all our third-party providers--}}
                                                        ...
                                                        {{--that compromise or violate the privacy of our users.</p>--}}
                                                    {{--<h3>How you can control or opt out of cookies</h3>--}}
                                                    {{--<p>If you do not wish to accept cookies from us, you can instruct--}}
                                                        ...
                                                        {{--you when a website is trying to set or update a cookie.</p>--}}
                                                    {{--<p>If you browse websites from multiple devices, you may need to--}}
                                                        {{--update your settings on each individual device.</p>--}}
                                                    {{--<p>Although some cookies can be blocked with little impact on your--}}
