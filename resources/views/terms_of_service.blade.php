...
@section('meta')
    <title>Terms of service - AidSpace</title>
    <meta property="og:locale" content="en_US"/>
    <meta property="og:type" content="article"/>
    <meta property="og:title" content="Terms of service - AidSpace"/>
    ...
    <meta name="twitter:title" content="Terms of service - AidSpace"/>
...
@section('content')
    ...
    <section class="terms-of-service-content">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="wrapper-terms-of-service">
                        <h3>1. Terms</h3>
                        <p>By accessing the website at&nbsp;<a href="https://volunteers.aidspace.io/">https://volunteers.aidspace.io</a>,
                        ...
                        <ol type="a">
                            <li>Permission is granted to temporarily download one copy of the materials (information or
                                software) on AidSpace IVS’ website for personal, non-commercial transitory viewing only.
                                ...
                                <ol type="i">
                                    ...
                                    <li>attempt to decompile or reverse engineer any software contained on AidSpace IVS’
                                        website;
                                    </li>
                            ...
                            <li>This license shall automatically terminate if you violate any of these restrictions and
                                may be terminated by AidSpace IVS at any time. Upon terminating your viewing of these
                        ...
                        <h3>3. Disclaimer</h3>
                        <ol type="a">
                            <li>The materials on AidSpace IVS’ website are provided on an ‘as is’ basis. AidSpace IVS
                                makes no warranties, expressed or implied, and hereby disclaims and negates all other
                                warranties including, without limitation, implied warranties or conditions of
                                merchantability, fitness for a particular purpose, or non-infringement of intellectual
                                property or other violation of rights.
                            </li>
                            <li>Further, AidSpace IVS does not warrant or make any representations concerning the
                        ...
                        <h3>4. Limitations</h3>
                        <p>In no event shall AidSpace IVS or its suppliers be liable for any damages (including, without
                            limitation, damages for loss of data or profit, or due to business interruption) arising out
                            of the use or inability to use the materials on AidSpace IVS’ website, even if AidSpace IVS
                            or a AidSpace IVS authorized representative has been notified orally or in writing of the
                        ...
                        <p>The materials appearing on AidSpace IVS’ website could include technical, typographical, or
                            photographic errors. AidSpace IVS does not warrant that any of the materials on its website
                            are accurate, complete or current. AidSpace IVS may make changes to the materials contained
                            on its website at any time without notice. However AidSpace IVS does not make any commitment
                            to update the materials.</p>
                        <h3>6. Links</h3>
                        <p>AidSpace IVS has not reviewed all of the sites linked to its website and is not responsible
                            for the contents of any such linked site. The inclusion of any link does not imply
                            endorsement by AidSpace IVS of the site. Use of any such linked website is at the user’s own
                            risk.</p>
                        <h3>7. Modifications</h3>
                        <p>AidSpace IVS may revise these terms of service for its website at any time without notice. By
                        ...
                        <p>These terms and conditions are governed by and construed in accordance with the laws of
                            Denmark and you irrevocably submit to the exclusive jurisdiction of the courts in that State
                            or location.</p>
                    </div>
                </div>
            </div>
