        ...
        <div class="container">
            <div class="wrapper-latest-features-content">
                ...
                <div class="accordion-mobile" id="accordion">
                    <div class="card">
                        ...
                        <div id="collapseOne" class="collapse" aria-labelledby="headingOne"
                            ...
                            <div class="card-body">
                                ...
                                <p><span
                                        style="font-weight: 400;">Click on the profile image on top right of yor screen</span><span
                    ...
                    <div class="card">
                        ...
                        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion">
                            <div class="card-body">
                                <p><strong>Organizes and presents information in an easy to read manner. A way to
                                        communicate and
                                        give your users up-to-date information. Dashboard is the first page that loads
                                        on your
                    ...
                    <div class="card">
                        ...
                        <div id="collapseThree" class="collapse" aria-labelledby="headingThree"
                             data-parent="#accordion">
                            <div class="card-body">
                                <p><strong>Handle volunteer profiles with all the information – add and edit or remove,
                                        or
                                        deactivate.&nbsp;</strong></p>
                                ...
                                <ul>
                                    <li><span
                                            style="font-weight: 400;">Education, Skills and Languages –&nbsp;</span><span
                    ...
                    <div class="card">
                        ...
                        <div id="collapseFive" class="collapse" aria-labelledby="headingFive"
                             data-parent="#accordion">
                            <div class="card-body">
                                <p><strong>Exchange emails with your fellow coordinators and administrators, share
                                        important
                                ...
                                <ul>
                                    <li style="font-weight: 400;"><span style="font-weight: 400;">Press “+” button. A pop up appears with many useful options.&nbsp;</span>
                                        <ul>
                                            ...
                                            <li style="font-weight: 400;"><span
                                                    style="font-weight: 400;">Select areas </span></li>
                    ...
                    <div class="card">
                        ...
                        <div id="collapseSix" class="collapse" aria-labelledby="headingSix"
                             data-parent="#accordion">
                            <div class="card-body">
                                <p style="text-align: left;"><strong>Extract synthesized information of your
                                        choice. </strong></p>
                                <p><span
                                        style="font-weight: 400;">Extract synthesized information of your choice. </span>
                                </p>
                    ...
                    <div class="card">
                        ...
                        <div id="collapseSeven" class="collapse" aria-labelledby="headingSeven"
                             data-parent="#accordion">
                            <div class="card-body">
                                <p><strong>This is the feature that helps organising and distributing shifts.</strong>
                                </p>
                                <p><span
                                ...
                                <ul>
                                    <li style="font-weight: 400;"><span style="font-weight: 400;">Assignee status goes through these stages:</span>
                                        <ul>
                                            ...
                                            <li style="font-weight: 400;"><span
                                                    style="font-weight: 400;">Approved</span></li>
                                        </ul>
                                    </li>
                                </ul>
                        ...
                        <div id="collapseNine" class="collapse" aria-labelledby="headingNine"
                            ...
                            <div class="card-body">
                                ...
                                <ul>
                                    ...
                                    <li style="font-weight: 400;"><span style="font-weight: 400;">Delete users.</span>
                                    </li>
                                </ul>
                ...
                <div id="Volunteers" class="tabcontent">
                    ...
                    <div class="tabcontent-content vc_box_shadow_3d box_shadow">
                        <img width="1024" height="623" src="{{ asset('images/volunteers-16-1024x623.png') }}"
                             alt="volunteer profile, tutorials see history">
                    </div>
                </div>
            ...
            <div class="wrapper-latest-features-content-2">
                <h3 class="wow fadeIn" style=""><strong><span
                            style="text-decoration: underline;">Volunteers</span></strong></h3>

                <div class="wrapper-latest-features-content">

                    <div class="accordion-mobile" id="accordion2">

                        <div class="card">
                            <div class="card-header" id="headingOne2">
                                <button href="#" class="tab-item" data-toggle="collapse" data-target="#collapseOne2"
                            ...
                            <div id="collapseOne2" class="collapse" aria-labelledby="headingOne2"
                                ...
                                <div class="card-body">
                                    <p><strong>Your way to communicate and get up-to-date information from your
                                            coordinator and
                                            administrators. Dashboard is the first page that loads on your screen once
                                            you log
                                            in.</strong></p>
                                    ...
                                    <p><span
                                            style="font-weight: 400;">1. Comment on post: Click on Comments filed&nbsp;</span><span
                                            style="font-weight: 400;">and the post will open with text area where you can type your comments and click “Send”.</span>
                                    </p>
                        ...
                        <div class="card">
                            <div class="card-header" id="headingTwo2">
                                <button href="#" class="tab-item" data-toggle="collapse" data-target="#collapseTwo2"
                            ...
                            <div id="collapseTwo2" class="collapse" aria-labelledby="headingTwo2"
                                ...
                                <div class="card-body">
                                    ...
                                    <p><span
                                            style="font-weight: 400;">1. Profile tab. Manage your basic data here.</span>
                                    </p>
                                    <ul>
                                    ...
                                    <ul>
                                        ...
                                        <li style="font-weight: 400;"><span
                                                style="font-weight: 400;">Or edit your email</span></li>
                                    </ul>
                        ...
                        <div class="card">
                            <div class="card-header" id="headingThree2">
                                <button href="#" class="tab-item" data-toggle="collapse" data-target="#collapseThree2"
                        ...
                        <div class="card">
                            <div class="card-header" id="headingFour2">
                                <button href="#" class="tab-item" data-toggle="collapse" data-target="#collapseFour2"
                            ...
                            <div id="collapseFour2" class="collapse" aria-labelledby="headingFour2"
                                ...
                                <div class="card-body">
                                    ...
                                    <p><span style="font-weight: 400;">Month</span><span
                                            style="font-weight: 400;">:</span></p>
                        ...
                        <div class="card">
                            <div class="card-header" id="headingFive2">
                                <button href="#" class="tab-item" data-toggle="collapse" data-target="#collapseFive2"
