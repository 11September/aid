...
@section('content')
    {{--<div id="hgr_sections">--}}
        {{--<div id="how-it-works" class="row standAlonePage">--}}
            {{--<div class="vc_col-md-12 noPadding">--}}
                {{--<div class="container">--}}
                    {{--<div class="slideContent gu12">--}}
                        {{--<section id="case-study-3" class="vc_section light-scheme vc_custom_1499085398858">--}}
                                    ...
                                    {{--<div class="vc_column-inner ">--}}
                                        {{--<div class="wpb_wrapper">--}}
                                            {{--<div--}}
                                                {{--class="wpb_text_column wpb_content_element  wpb_animate_when_almost_visible wpb_fadeIn fadeIn">--}}
                                                {{--<div class="wpb_wrapper">--}}
                                                    {{--<h3 style="text-align: center;"><strong><span--}}
                                                                {{--style="text-decoration: underline;">Administrators and Coordinators</span></strong>--}}
                                                    {{--</h3>--}}
                                                {{--</div>--}}
                                            {{--</div>--}}
                                        {{--</div>--}}
                            ...
                            {{--<div class="vc_row wpb_row vc_row-fluid vc_custom_1493127194055">--}}
                                    ...
                                    {{--<div class="vc_column-inner ">--}}
                                        {{--<div class="wpb_wrapper">--}}
                                            {{--<div class="vc_tta-container" data-vc-action="collapse">--}}
                                                {{--<div--}}
                                                    {{--class="vc_general vc_tta vc_tta-tabs vc_tta-color-white vc_tta-style-modern vc_tta-shape-rounded vc_tta-spacing-5 vc_tta-gap-30 vc_tta-o-no-fill vc_tta-tabs-position-left vc_tta-controls-align-left vc_tta-controls-size-sm">--}}
                                                    {{--<div class="vc_tta-tabs-container">--}}
                                                        {{--<ul class="vc_tta-tabs-list">--}}
                                                            {{--<li class="vc_tta-tab vc_active" data-vc-tab><a--}}
                                                                    {{--href="#1493126845611-61b6b464-c3abdc90-d9e3"--}}
                                                                    {{--data-vc-tabs data-vc-container=".vc_tta"><span--}}
                                                                        {{--class="vc_tta-title-text">My profile</span></a>--}}
                                                            {{--</li>--}}
                                                            {{--<li class="vc_tta-tab" data-vc-tab><a--}}
                                                                    {{--href="#1493127700498-f07b0474-811adc90-d9e3"--}}
                                                                    {{--data-vc-tabs data-vc-container=".vc_tta"><span--}}
                                                                        {{--class="vc_tta-title-text">Dashboard</span></a>--}}
                                                            {{--</li>--}}
                                                            {{--<li class="vc_tta-tab" data-vc-tab><a--}}
                                                                    {{--href="#1493127699281-1a731d77-e659dc90-d9e3"--}}
                                                                    {{--data-vc-tabs data-vc-container=".vc_tta"><span--}}
                                                                        {{--class="vc_tta-title-text">Volunteers</span></a>--}}
                                                            {{--</li>--}}
                                                            {{--<li class="vc_tta-tab" data-vc-tab><a--}}
                                                                    {{--href="#1493127698530-ebe7c6ed-2cb5dc90-d9e3"--}}
                                                                    {{--data-vc-tabs data-vc-container=".vc_tta"><span--}}
                                                                        {{--class="vc_tta-title-text">Advanced search</span></a>--}}
                                                            {{--</li>--}}
                                                            {{--<li class="vc_tta-tab" data-vc-tab><a--}}
                                                                    {{--href="#1493127722043-b4b26066-7b45dc90-d9e3"--}}
                                                                    {{--data-vc-tabs data-vc-container=".vc_tta"><span--}}
                                                                        {{--class="vc_tta-title-text">Messages</span></a>--}}
                                                            {{--</li>--}}
                                                            {{--<li class="vc_tta-tab" data-vc-tab><a--}}
                                                                    {{--href="#1493127697685-f8c1624b-f840dc90-d9e3"--}}
                                                                    {{--data-vc-tabs data-vc-container=".vc_tta"><span--}}
                                                                        {{--class="vc_tta-title-text">Reports</span></a>--}}
                                                            {{--</li>--}}
                                                            {{--<li class="vc_tta-tab" data-vc-tab><a--}}
                                                                    {{--href="#1493127768667-ca39ab39-3af0dc90-d9e3"--}}
                                                                    {{--data-vc-tabs data-vc-container=".vc_tta"><span--}}
                                                                        {{--class="vc_tta-title-text">Schedule</span></a>--}}
                                                            {{--</li>--}}
                                                            {{--<li class="vc_tta-tab" data-vc-tab><a--}}
                                                                    {{--href="#1539326407360-d0486c0c-07b4" data-vc-tabs--}}
                                                                    {{--data-vc-container=".vc_tta"><span--}}
                                                                        {{--class="vc_tta-title-text">Events</span></a>--}}
                                                            {{--</li>--}}
                                                            {{--<li class="vc_tta-tab" data-vc-tab><a--}}
                                                                    {{--href="#1539326426041-3c931806-1a07" data-vc-tabs--}}
                                                                    {{--data-vc-container=".vc_tta"><span--}}
                                                                        {{--class="vc_tta-title-text">Settings</span></a>--}}
                                                            {{--</li>--}}
                                                        {{--</ul>--}}
                                                    {{--</div>--}}
                                                    {{--<div class="vc_tta-panels-container">--}}
                                                        {{--<div class="vc_tta-panels">--}}
                                                            {{--<div class="vc_tta-panel vc_active"--}}
                                                                 {{--id="1493126845611-61b6b464-c3abdc90-d9e3"--}}
                                                                ...
                                                                {{--<div class="vc_tta-panel-body">--}}
                                                                    {{--<div--}}
                                                                        ...
                                                                        {{--<div class="wpb_wrapper">--}}
                                                                            {{--<p><strong>Choose different options for--}}
                                                                                    {{--your--}}
                                                                                    {{--own profile.</strong></p>--}}
                                                                    ...
                                                                    {{--<div--}}
                                                                        ...
                                                                        {{--<div class="wpb_wrapper">--}}
                                                                            {{--<p><span style="font-weight: 400;">Click on the profile image on top right of yor screen</span><span--}}
                                                                                    {{--style="font-weight: 400;"> and from the menu choose My profile.</span>--}}
                                                                            {{--</p>--}}
                                                                        ...
                                                                        {{--<figure class="wpb_wrapper vc_figure">--}}
                                                                            {{--<div--}}
                                                                                ...
                                                                                {{--<img width="1024" height="318"--}}
                                                                                     {{--src="{{ asset('images/My-profie-1024x318.png') }}"--}}
                                                                                     ...
                                                                                     {{--srcset="{{ asset('images/My-profie-1024x318.png') }}"--}}
                                                                        ...
                                                                        {{--<figure class="wpb_wrapper vc_figure">--}}
                                                                            {{--<div--}}
                                                                                ...
                                                                                {{--<img width="1024" height="307"--}}
                                                                                     ...
                                                                                     {{--class="vc_single_image-img attachment-large"--}}
                                                                                     {{--alt="volunteer administrator, coordinator, tutorials, my profile administrator coordinator"--}}
                                                                                     {{--srcset="{{ asset('images/my-profile-2-1024x307.png') }}"--}}
                                                                                     {{--sizes="(max-width: 1024px) 100vw, 1024px"/>--}}
                                                                            {{--</div>--}}
                                                                        {{--</figure>--}}
                                                                    {{--</div>--}}
                                                                        ...
                                                                        {{--<div class="wpb_wrapper">--}}
                                                                            {{--<ol>--}}
                                                                                {{--<li style="font-weight: 400;"><span--}}
                                                                                        {{--style="font-weight: 400;">Edit my profile &#8211; </span>--}}
                                                                                    {{--<ul>--}}
                                                                                        {{--<li style="font-weight: 400;">--}}
                                                                                                {{--<span--}}
                                                                                                    {{--style="font-weight: 400;">Change your current password or </span><span--}}
                                                                        ...
                                                                        {{--<figure class="wpb_wrapper vc_figure">--}}
                                                                            {{--<div--}}
                                                                                ...
                                                                                {{--<img width="875" height="815"--}}
                                                                                     ...
                                                                                     {{--srcset="{{ asset('images/my-profile-3.png') }}"--}}
                                                                    ...
                                                                    {{--<div--}}
                                                                        ...
                                                                        {{--<div class="wpb_wrapper">--}}
                                                                            {{--<ul>--}}
                                                                                {{--<li style="font-weight: 400;"><span--}}
                                                                                        {{--style="font-weight: 400;">If you are to be responsible for all volunteers in the organisation in many matters and occasions scroll down to the bottom of the pop up and check  “Can see all volunteers”. This is how it should look like once you chose the option</span><span--}}
                                                                        ...
                                                                        {{--<figure class="wpb_wrapper vc_figure">--}}
                                                                            {{--<div--}}
                                                                                ...
                                                                                {{--<img width="870" height="807"--}}
                                                                                     ...
                                                                                     {{--class="vc_single_image-img attachment-large"--}}
                                                                                     {{--alt="volunteer administrator, coordinator, tutorials, settings module, edit user"--}}
                                                                                     {{--srcset="{{ asset('images/my-profile-4.png') }}"--}}
                                                                        ...
                                                                        {{--<div class="wpb_wrapper">--}}
                                                                            {{--<p><span style="font-weight: 400;">      2. Change role. </span><span--}}
                                                                                    ...
                                                                                    {{--style="text-decoration: underline;"><a--}}
                                                                                        {{--href="mailto:info@aidspace.io"><span--}}
                                                                                            {{--style="font-weight: 400;">info@aidspace.io</span></a></span><span--}}
                                                                                    {{--style="font-weight: 400;"> and provide us with information on the request. </span>--}}
                                                                            {{--</p>--}}
                                                            ...
                                                            {{--<div class="vc_tta-panel"--}}
                                                                 {{--id="1493127700498-f07b0474-811adc90-d9e3"--}}
                                                                 {{--data-vc-content=".vc_tta-panel-body">--}}
                                                                {{--<div class="vc_tta-panel-heading"><h4--}}
                                                                        {{--class="vc_tta-panel-title"><a--}}
                                                                            {{--href="#1493127700498-f07b0474-811adc90-d9e3"--}}
                                                                ...
                                                                {{--<div class="vc_tta-panel-body">--}}
                                                                    {{--<div--}}
                                                                        {{--class="wpb_text_column wpb_content_element ">--}}
                                                                        {{--<div class="wpb_wrapper">--}}
                                                                            {{--<p><strong>Organizes and presents--}}
                                                                                    {{--information in an easy to read--}}
                                                                                    {{--manner. A--}}
                                                                                    {{--way to communicate and give your--}}
                                                                                    {{--users--}}
                                                                                    {{--up-to-date information.--}}
                                                                                    {{--Dashboard is the--}}
                                                                                    {{--first page that loads on your--}}
                                                                                    {{--screen--}}
                                                                                    {{--once you log in.</strong></p>--}}
                                                                        ...
                                                                        {{--<figure class="wpb_wrapper vc_figure">--}}
                                                                            {{--<div--}}
                                                                                ...
                                                                                {{--<img width="1024" height="482"--}}
                                                                                     {{--src="{{ asset('images/dashboard-1-1024x482.png') }}"--}}
                                                                                     {{--class="vc_single_image-img attachment-large"--}}
                                                                                     {{--alt="dashboard module, tutorials,"--}}
                                                                                     {{--srcset="{{ asset('images/dashboard-1-1024x482.png') }}"--}}
                                                                                     {{--sizes="(max-width: 1024px) 100vw, 1024px"/>--}}
                                                                            {{--</div>--}}
                                                                        {{--</figure>--}}
                                                                    {{--</div>--}}
                                                                        ...
                                                                        {{--<figure class="wpb_wrapper vc_figure">--}}
                                                                            {{--<div--}}
                                                                                ...
                                                                                {{--<img width="968" height="490"--}}
                                                                                     ...
                                                                                     {{--srcset="{{ asset('images/dashboard-2.png') }}"--}}
                                                                    ...
                                                                    {{--<div--}}
                                                                        {{--class="wpb_text_column wpb_content_element ">--}}
                                                                        {{--<div class="wpb_wrapper">--}}
                                                                            {{--<p>This is how a post with “Disable--}}
                                                                                {{--comments” function look like:</p>--}}
                                                            ...
                                                            {{--</div>--}}
                                                            {{--<div class="vc_tta-panel"--}}
                                                                 {{--id="1493127699281-1a731d77-e659dc90-d9e3"--}}
                                                                 {{--data-vc-content=".vc_tta-panel-body">--}}
                                                                {{--<div class="vc_tta-panel-heading"><h4--}}
                                                                        {{--class="vc_tta-panel-title"><a--}}
                                                                            {{--href="#1493127699281-1a731d77-e659dc90-d9e3"--}}
                                                                ...
                                                                {{--<div class="vc_tta-panel-body">--}}
                                                                    {{--<div--}}
                                                                        {{--class="wpb_text_column wpb_content_element ">--}}
                                                                        {{--<div class="wpb_wrapper">--}}
                                                                            {{--<p><strong>Handle volunteer profiles--}}
                                                                                    {{--with--}}
                                                                                    {{--all the information &#8211; add--}}
                                                                                    {{--and edit--}}
                                                                                    {{--or remove, or--}}
                                                                                    {{--deactivate. </strong></p>--}}
                                                                    ...
                                                                    {{--<div--}}
                                                                        ...
                                                                        {{--<div class="wpb_wrapper">--}}
                                                                            {{--<ul>--}}
                                                                                {{--<li style="font-weight: 400;"><span--}}
                                                                                        {{--style="font-weight: 400;">The list includes data as contact email, phone number, country, availability of the volunteer and their status. You can choose to arrange them according their names, emails, country or status in ascending or descending order. </span>--}}
                                                                                {{--</li>--}}
                                                                                {{--<li style="font-weight: 400;"><span--}}
                                                                                        {{--style="font-weight: 400;">To go through the profile of the volunteer and edit, press on the grey field that appears when you scroll over the list. </span>--}}
                                                                                {{--</li>--}}
                                                                                {{--<li style="font-weight: 400;"><span--}}
                                                                                        {{--style="font-weight: 400;">Quick options menu allow you to delete, export data or inactivate the person from the system. </span>--}}
                                                                                {{--</li>--}}
                                                                            {{--</ul>--}}
                                                                    ...
                                                                    {{--<div--}}
                                                                        {{--class="wpb_text_column wpb_content_element ">--}}
                                                                        {{--<div class="wpb_wrapper">--}}
                                                                            {{--<p><span style="font-weight: 400;">2. Create new volunteer. </span>--}}
                                                                            {{--</p>--}}
                                                                            {{--<ul>--}}
                                                                                {{--<li style="font-weight: 400;"><span--}}
                                                                                        {{--style="font-weight: 400;">Press “+”button. A pop up appears with your form. </span>--}}
                                                                                {{--</li>--}}
                                                                                {{--<li style="font-weight: 400;"><span--}}
                                                                                        {{--style="font-weight: 400;">Profile picture &#8211; Add their profile picture from the top left icon to upload and mind the requirements on size: max.5 mb.; width 150px and height 150px. </span>--}}
                                                                                {{--</li>--}}
                                                                            {{--</ul>--}}
                                                                    ...
                                                                    {{--<div--}}
                                                                        ...
                                                                        {{--<div class="wpb_wrapper">--}}
                                                                            {{--<ul>--}}
                                                                                {{--<li style="font-weight: 400;"><span--}}
                                                                                        {{--style="font-weight: 400;">Profile section. Insert personal info for the volunteer as names, birthday and registration email (those are required and you won’t be able to complete the new profile without them). Once you entered the required data and saved it,  next to the volunteer’s email address or phone number you will notice new icons: Delete, Send verification email and See history. </span>--}}
                                                                                    {{--<ul>--}}
                                                                                        {{--<li style="font-weight: 400;">--}}
                                                                                                {{--<span--}}
                                                                                                    {{--style="font-weight: 400;">In order the correct notification process &#8211; you must have their email or phone number confirmed and allow them to pick the way they want to receive notifications &#8211; via emails or SMS. </span>--}}
                                                                                        {{--</li>--}}
                                                                                        {{--<li style="font-weight: 400;">--}}
                                                                                                {{--<span--}}
                                                                                                    {{--style="font-weight: 400;">Birthdays/ Anniversaries &#8211; you will automatically receive notification so you won’t miss them three months before the event. </span>--}}
                                                                                        {{--</li>--}}
                                                                                        {{--<li style="font-weight: 400;">--}}
                                                                                                {{--<span--}}
                                                                                                    {{--style="font-weight: 400;">Criminal record/ Child certificate &#8211; you will receive automated notifications three months before the expiry date.</span>--}}
                                                                                        {{--</li>--}}
                                                                                    {{--</ul>--}}
                                                                                {{--</li>--}}
                                                                            {{--</ul>--}}
                                                                        ...
                                                                        {{--<figure class="wpb_wrapper vc_figure">--}}
                                                                            {{--<div--}}
                                                                                ...
                                                                                {{--<img width="1024" height="624"--}}
                                                                                     {{--src="{{ asset('images/volunteers-6-1024x624.png') }}"--}}
                                                                                     {{--class="vc_single_image-img attachment-large"--}}
                                                                                     {{--alt="volunteer administrator, coordinator, tutorials, email verification for volunteer"--}}
                                                                                     {{--srcset="https://aidspace.io/wp-content/uploads/2018/10/volunteers-6-1024x624.png 1024w, https://aidspace.io/wp-content/uploads/2018/10/volunteers-6-300x183.png 300w, https://aidspace.io/wp-content/uploads/2018/10/volunteers-6-768x468.png 768w, https://aidspace.io/wp-content/uploads/2018/10/volunteers-6-600x365.png 600w, https://aidspace.io/wp-content/uploads/2018/10/volunteers-6.png 1338w"--}}
                                                                                     {{--sizes="(max-width: 1024px) 100vw, 1024px"/>--}}
                                                                            {{--</div>--}}
                                                                        {{--</figure>--}}
                                                                    {{--</div>--}}
                                                                        ...
                                                                        {{--<div class="wpb_wrapper">--}}
                                                                            {{--<ul>--}}
                                                                                {{--<li><span style="font-weight: 400;">Education, Skills and Languages &#8211; </span><span--}}
                                                                                        {{--style="font-weight: 400;">add accordingly one or more.</span>--}}
                                                                                {{--</li>--}}
                                                                            {{--</ul>--}}
                                                                    ...
                                                                    {{--<div--}}
                                                                        ...
                                                                        {{--<div class="wpb_wrapper">--}}
                                                                            {{--<ul>--}}
                                                                                {{--<li><span style="font-weight: 400;">Work. </span><span--}}
                                                                                        {{--style="font-weight: 400;">In this section you can insert data on the volunteers current or past activities in the organisation and some very important details such as their reason for leaving the position. </span>--}}
                                                                                {{--</li>--}}
                                                                            {{--</ul>--}}
                                                                    ...
                                                                    {{--<div--}}
                                                                        ...
                                                                        {{--<div class="wpb_wrapper">--}}
                                                                            {{--<ul>--}}
                                                                                {{--<li><span style="font-weight: 400;">Documents. </span><span--}}
                                                                                        {{--style="font-weight: 400;">Upload all required documents. </span>--}}
                                                                                {{--</li>--}}
                                                                            {{--</ul>--}}
                                                                    ...
                                                                    {{--<div--}}
                                                                        ...
                                                                        {{--<div class="wpb_wrapper">--}}
                                                                            {{--<ul>--}}
                                                                                {{--<li><span style="font-weight: 400;">Equipment. </span><span--}}
                                                                                        {{--style="font-weight: 400;">Sometimes organisations provide materials in order to ensure the volunteers performance.</span>--}}
                                                                                {{--</li>--}}
                                                                            {{--</ul>--}}
                                                                    ...
                                                                    {{--<div--}}
                                                                        ...
                                                                        {{--<div class="wpb_wrapper">--}}
                                                                            {{--<ul>--}}
                                                                                {{--<li><span style="font-weight: 400;">Availability. </span><span--}}
                                                                                        {{--style="font-weight: 400;">You can enter yourself the volunteers availability. (They can do that themselves from their own profile). </span>--}}
                                                                                    {{--<ul>--}}
                                                                                        {{--<li style="font-weight: 400;">--}}
                                                                                                {{--<span--}}
                                                                                                    {{--style="font-weight: 400;">Enter their availability &#8211; click “Add” button </span><span--}}
                                                                    ...
                                                                    {{--<div--}}
                                                                        ...
                                                                        {{--<div class="wpb_wrapper">--}}
                                                                            ...
                                                                            {{--<ul>--}}
                                                                                {{--<li style="font-weight: 400;"><span--}}
                                                                                        {{--style="font-weight: 400;">Use “See history” icons to follow up with the changes you have made so far. </span>--}}
                                                                                {{--</li>--}}
                                                                            {{--</ul>--}}
                                                                    ...
                                                                    {{--<div--}}
                                                                        ...
                                                                        {{--<figure class="wpb_wrapper vc_figure">--}}
                                                                            {{--<div--}}
                                                                                {{--class="vc_single_image-wrapper vc_box_shadow_3d  vc_box_border_grey">--}}
                                                                                {{--<img width="1024" height="623"--}}
                                                                                     {{--src="{{ asset('images/volunteers-16-1024x623.png') }}"--}}
                                                                                     {{--class="vc_single_image-img attachment-large"--}}
                                                                                     {{--alt="volunteer profile, tutorials see history"--}}
                                                            ...
                                                            {{--</div>--}}
                                                            {{--<div class="vc_tta-panel"--}}
                                                                 {{--id="1493127698530-ebe7c6ed-2cb5dc90-d9e3"--}}
                                                                 {{--data-vc-content=".vc_tta-panel-body">--}}
                                                                {{--<div class="vc_tta-panel-heading"><h4--}}
                                                                        {{--class="vc_tta-panel-title"><a--}}
                                                                            {{--href="#1493127698530-ebe7c6ed-2cb5dc90-d9e3"--}}
                                                                ...
                                                                {{--<div class="vc_tta-panel-body">--}}
                                                                    {{--<div--}}
                                                                        {{--class="wpb_text_column wpb_content_element ">--}}
                                                                        {{--<div class="wpb_wrapper">--}}
                                                                            {{--<p><strong>Search a volunteer on a--}}
                                                                                    {{--number of--}}
                                                                                    {{--criteria.</strong></p>--}}
                                                                    ...
                                                                    {{--<div--}}
                                                                        {{--class="wpb_text_column wpb_content_element ">--}}
                                                                        {{--<div class="wpb_wrapper">--}}
                                                                            {{--<p><span style="font-weight: 400;">There are two ways to access the advanced search module: </span>--}}
                                                                            {{--</p>--}}
                                                                    ...
                                                                    {{--<div--}}
                                                                        {{--class="wpb_text_column wpb_content_element ">--}}
                                                                        {{--<div class="wpb_wrapper">--}}
                                                                            {{--<p><span style="font-weight: 400;">There is also a section on the main menu on the left sidebar. </span>--}}
                                                                            {{--</p>--}}
                                                                                ...
                                                                                {{--<li style="list-style-type: none;">--}}
                                                                                    {{--<ul>--}}
                                                                                        {{--<li style="list-style-type: none;">--}}
                                                                                            {{--<ul>--}}
                                                                                                {{--<li><span--}}
                                                                                                        {{--style="font-weight: 400;">Note: Skills and Languages fields in volunteer profiles must be filled in order to have every single skill and language in the search options. If you don’t fill them you will see this note:</span>--}}
                                                                                                {{--</li>--}}
                                                                                            {{--</ul>--}}
                                                                                        {{--</li>--}}
                                                                                    {{--</ul>--}}
                                                            ...
                                                            {{--</div>--}}
                                                            {{--<div class="vc_tta-panel"--}}
                                                                 {{--id="1493127722043-b4b26066-7b45dc90-d9e3"--}}
                                                                 {{--data-vc-content=".vc_tta-panel-body">--}}
                                                                {{--<div class="vc_tta-panel-heading"><h4--}}
                                                                        {{--class="vc_tta-panel-title"><a--}}
                                                                            {{--href="#1493127722043-b4b26066-7b45dc90-d9e3"--}}
                                                                ...
                                                                {{--<div class="vc_tta-panel-body">--}}
                                                                    {{--<div--}}
                                                                        {{--class="wpb_text_column wpb_content_element ">--}}
                                                                        {{--<div class="wpb_wrapper">--}}
                                                                            {{--<p><strong>Exchange emails with your--}}
                                                                                    {{--fellow--}}
                                                                                    {{--coordinators and administrators,--}}
                                                                                    {{--share--}}
                                                                                    {{--important information inside the--}}
                                                                                    {{--app--}}
                                                                                    {{--with volunteers.</strong></p>--}}
                                                                    ...
                                                                    {{--<div--}}
                                                                        {{--class="wpb_text_column wpb_content_element ">--}}
                                                                        {{--<div class="wpb_wrapper">--}}
                                                                            {{--<p><span style="font-weight: 400;">This is your inbox:</span>--}}
                                                                            {{--</p>--}}
                                                                    ...
                                                                    {{--<div--}}
                                                                        ...
                                                                        {{--<div class="wpb_wrapper">--}}
                                                                            {{--<ol>--}}
                                                                                {{--<li><span style="font-weight: 400;">Create new message. </span>--}}
                                                                                {{--</li>--}}
                                                                            {{--</ol>--}}
                                                                            {{--<ul>--}}
                                                                                {{--<li style="font-weight: 400;"><span--}}
                                                                                        {{--style="font-weight: 400;">Press “+” button. A pop up appears with many useful options. </span>--}}
                                                                                    {{--<ul>--}}
                                                                                        {{--<li style="font-weight: 400;">--}}
                                                                                                {{--<span--}}
                                                                                                    {{--style="font-weight: 400;">Send a message to all active volunteers or include inactive as well. Note: when you personally want to address a volunteer do not switch the button on because your message will be automatically sent to all active volunteers as well. </span>--}}
                                                                                        {{--</li>--}}
                                                                                        {{--<li style="font-weight: 400;">--}}
                                                                                                {{--<span--}}
                                                                                                    {{--style="font-weight: 400;">Select groups for your message</span>--}}
                                                                                        {{--</li>--}}
                                                                                        {{--<li style="font-weight: 400;">--}}
                                                                                                {{--<span--}}
                                                                                                    {{--style="font-weight: 400;">Select areas </span>--}}
                                                                                        {{--</li>--}}
                                                                                        {{--<li style="font-weight: 400;">--}}
                                                                                                {{--<span--}}
                                                                                                    {{--style="font-weight: 400;">Select volunteers &#8211; personalize your message </span>--}}
                                                                                        {{--</li>--}}
                                                                                        {{--<li style="font-weight: 400;">--}}
                                                                                                {{--<span--}}
                                                                                                    {{--style="font-weight: 400;">Send a copy to your coordinator or fellow coordinators and administrator</span>--}}
                                                                                        {{--</li>--}}
                                                                                    {{--</ul>--}}
                                                                                {{--</li>--}}
                                                                            {{--</ul>--}}
                                                                    ...
                                                                    {{--<div--}}
                                                                        ...
                                                                        {{--<div class="wpb_wrapper">--}}
                                                                            {{--<ul>--}}
                                                                                {{--<li style="font-weight: 400;"><span--}}
                                                                                        {{--style="font-weight: 400;">If you have been sent a message inside the app &#8211; you will receive notification by your prefered method of contact. </span>--}}
                                                                                {{--</li>--}}
                                                                                {{--<li style="font-weight: 400;"><span--}}
                                                                                        {{--style="font-weight: 400;">All new unread messages appear on the left side of your screen with a red indicator. When scroll click the message and your right side of the screen will open the message. </span>--}}
                                                                                    {{--<ul>--}}
                                                                                        {{--<li style="font-weight: 400;">--}}
                                                                                                {{--<span--}}
                                                                                                    {{--style="font-weight: 400;">You can choose what to do with the message &#8211; reply to the sender only or if needed reply to all.</span>--}}
                                                                                        {{--</li>--}}
                                                                                        {{--<li style="font-weight: 400;">--}}
                                                                                                {{--<span--}}
                                                                                                    {{--style="font-weight: 400;">Or delete message from your inbox.</span>--}}
                                                                                        {{--</li>--}}
                                                                                    {{--</ul>--}}
                                                                                {{--</li>--}}
                                                                            {{--</ul>--}}
                                                            ...
                                                            {{--</div>--}}
                                                            {{--<div class="vc_tta-panel"--}}
                                                                 {{--id="1493127697685-f8c1624b-f840dc90-d9e3"--}}
                                                                 {{--data-vc-content=".vc_tta-panel-body">--}}
                                                                {{--<div class="vc_tta-panel-heading"><h4--}}
                                                                        {{--class="vc_tta-panel-title"><a--}}
                                                                            {{--href="#1493127697685-f8c1624b-f840dc90-d9e3"--}}
                                                                ...
                                                                {{--<div class="vc_tta-panel-body">--}}
                                                                    {{--<div--}}
                                                                        {{--class="wpb_text_column wpb_content_element ">--}}
                                                                        {{--<div class="wpb_wrapper">--}}
                                                                            {{--<p style="text-align: left;"><strong>Extract--}}
                                                                                    {{--synthesized information of your--}}
                                                                                    {{--choice. </strong></p>--}}
                                                                    ...
                                                                    {{--<div--}}
                                                                        {{--class="wpb_text_column wpb_content_element ">--}}
                                                                        {{--<div class="wpb_wrapper">--}}
                                                                            {{--<p><span style="font-weight: 400;">Extract synthesized information of your choice. </span>--}}
                                                                            {{--</p>--}}
                                                            ...
                                                            {{--</div>--}}
                                                            {{--<div class="vc_tta-panel"--}}
                                                                 {{--id="1493127768667-ca39ab39-3af0dc90-d9e3"--}}
                                                                 {{--data-vc-content=".vc_tta-panel-body">--}}
                                                                {{--<div class="vc_tta-panel-heading"><h4--}}
                                                                        {{--class="vc_tta-panel-title"><a--}}
                                                                            {{--href="#1493127768667-ca39ab39-3af0dc90-d9e3"--}}
                                                                ...
                                                                {{--<div class="vc_tta-panel-body">--}}
                                                                    {{--<div--}}
                                                                        {{--class="wpb_text_column wpb_content_element ">--}}
                                                                        {{--<div class="wpb_wrapper">--}}
                                                                            {{--<p><strong>This is the feature that--}}
                                                                                    {{--helps--}}
                                                                                    {{--organising and distributing--}}
                                                                                    {{--shifts.</strong>--}}
                                                                            {{--</p>--}}
                                                                        {{--</div>--}}
                                                                    {{--</div>--}}
                                                                    ...
                                                                    {{--<div--}}
                                                                        ...
                                                                        {{--<div class="wpb_wrapper">--}}
                                                                            {{--<p><span--}}
                                                                                    {{--style="font-weight: 400;">Week: </span>--}}
                                                                            {{--</p>--}}
                                                                    ...
                                                                    {{--<div--}}
                                                                        ...
                                                                        {{--<div class="wpb_wrapper">--}}
                                                                            {{--<p><span--}}
                                                                                    {{--style="font-weight: 400;">Month: </span>--}}
                                                                            {{--</p>--}}
                                                                    ...
                                                                    {{--<div--}}
                                                                        {{--class="wpb_text_column wpb_content_element ">--}}
                                                                        {{--<div class="wpb_wrapper">--}}
                                                                            {{--<p><span style="font-weight: 400;">2. Option to print in each view. </span>--}}
                                                                            {{--</p>--}}
                                                                            {{--<p><span style="font-weight: 400;">3. Create new shifts in each view. </span>--}}
                                                                            {{--</p>--}}
                                                                            {{--<p><span style="font-weight: 400;">4. To create a new shift press “+” button and a pop up will appear. </span>--}}
                                                                            {{--</p>--}}
                                                                            {{--<ul>--}}
                                                                                {{--<li style="font-weight: 400;"><span--}}
                                                                                        {{--style="font-weight: 400;">On Description page enter all details of the shift. Check “Published” so the shift will be accessible in the volunteers schedules and they can grab it. </span>--}}
                                                                                {{--</li>--}}
                                                                            {{--</ul>--}}
                                                                    ...
                                                                    {{--<div--}}
                                                                        ...
                                                                        {{--<div class="wpb_wrapper">--}}
                                                                            {{--<ul>--}}
                                                                                {{--<li style="font-weight: 400;"><span--}}
                                                                                        {{--style="font-weight: 400;">Once Description is saved you can now visit Assignments page to pick volunteers using different criteria. </span>--}}
                                                                                {{--</li>--}}
                                                                                {{--<li style="font-weight: 400;"><span--}}
                                                                                        {{--style="font-weight: 400;">If you want to personally recruit volunteers without publishing the shift don’t check “Published”. Just click “Save” and go to Assignments to pick a volunteer.</span>--}}
                                                                                {{--</li>--}}
                                                                            {{--</ul>--}}
                                                                            ...
                                                                            {{--<ul>--}}
                                                                                {{--<li><span style="font-weight: 400;">A shift goes through these statuses:</span>--}}
                                                                                    {{--<ul>--}}
                                                                                        {{--<li style="font-weight: 400;">--}}
                                                                                                {{--<span--}}
                                                                                                    {{--style="font-weight: 400;">Open &#8211; a shift is not started and a follow up is still to be sent</span>--}}
                                                                                        {{--</li>--}}
                                                                                        {{--<li style="font-weight: 400;">--}}
                                                                                                {{--<span--}}
                                                                                                    {{--style="font-weight: 400;">Followed up &#8211; an automatic email reminder is sent to the volunteer assigned, but who has not yet confirmed. Send 4 days before the shift start date.</span>--}}
                                                                                        {{--</li>--}}
                                                                                        {{--<li style="font-weight: 400;">--}}
                                                                                                {{--<span--}}
                                                                                                    {{--style="font-weight: 400;">Confirmed &#8211; the volunteer assigned has confirmed</span>--}}
                                                                                        {{--</li>--}}
                                                                                        {{--<li style="font-weight: 400;">--}}
                                                                                                {{--<span--}}
                                                                                                    {{--style="font-weight: 400;">In progress &#8211; a shift is in progress &#8211; i.e. the current time is between the from-to time period of the shift</span>--}}
                                                                                        {{--</li>--}}
                                                                                        {{--<li style="font-weight: 400;">--}}
                                                                                                {{--<span--}}
                                                                                                    {{--style="font-weight: 400;">Ended &#8211; a shift has ended normally</span>--}}
                                                                                        {{--</li>--}}
                                                                                        {{--<li style="font-weight: 400;">--}}
                                                                                                {{--<span--}}
                                                                                                    {{--style="font-weight: 400;">Cancelled &#8211; a shift is cancelled before it has ended</span>--}}
                                                                                        {{--</li>--}}
                                                                                    {{--</ul>--}}
                                                                                {{--</li>--}}
                                                                            {{--</ul>--}}
                                                                    ...
                                                                    {{--<div--}}
                                                                        ...
                                                                        {{--<div class="wpb_wrapper">--}}
                                                                            {{--<ul>--}}
                                                                                {{--<li style="font-weight: 400;"><span--}}
                                                                                        {{--style="font-weight: 400;">Assignee status goes through these stages:</span>--}}
                                                                                    {{--<ul>--}}
                                                                                        {{--<li style="font-weight: 400;">--}}
                                                                                                {{--<span--}}
                                                                                                    {{--style="font-weight: 400;">Awaiting acceptance (the assignee must confirm)</span>--}}
                                                                                        {{--</li>--}}
                                                                                        {{--<li style="font-weight: 400;">--}}
                                                                                                {{--<span--}}
                                                                                                    {{--style="font-weight: 400;">Awaiting approval ( administrator or coordinator must approve)</span>--}}
                                                                                        {{--</li>--}}
                                                                                        {{--<li style="font-weight: 400;">--}}
                                                                                                {{--<span--}}
                                                                                                    {{--style="font-weight: 400;">Rejected &#8211; (one of the users can reject) </span>--}}
                                                                                        {{--</li>--}}
                                                                                        {{--<li style="font-weight: 400;">--}}
                                                                                                {{--<span--}}
                                                                                                    {{--style="font-weight: 400;">Approved</span>--}}
                                                                                        {{--</li>--}}
                                                                                    {{--</ul>--}}
                                                                                {{--</li>--}}
                                                                            {{--</ul>--}}
                                                            ...
                                                            {{--</div>--}}
                                                            {{--<div class="vc_tta-panel"--}}
                                                                 {{--id="1539326407360-d0486c0c-07b4"--}}
                                                                 {{--data-vc-content=".vc_tta-panel-body">--}}
                                                                {{--<div class="vc_tta-panel-heading"><h4--}}
                                                                        {{--class="vc_tta-panel-title"><a--}}
                                                                            {{--href="#1539326407360-d0486c0c-07b4"--}}
                                                                            {{--data-vc-accordion--}}
                                                                            {{--data-vc-container=".vc_tta-container"><span--}}
                                                                                {{--class="vc_tta-title-text">Events</span></a>--}}
                                                                    {{--</h4>--}}
                                                                ...
                                                                {{--<div class="vc_tta-panel-body">--}}
                                                                    {{--<div--}}
                                                                        {{--class="wpb_text_column wpb_content_element ">--}}
                                                                        {{--<div class="wpb_wrapper">--}}
                                                                            {{--<p><span style="font-weight: 400;">1. Three comfortable views for your convenience &#8211; List</span>--}}
                                                                            {{--</p>--}}
                                                                        ...
                                                                        {{--<figure class="wpb_wrapper vc_figure">--}}
                                                                            {{--<div--}}
                                                                                ...
                                                                                {{--<img width="1024" height="621"--}}
                                                                                     ...
                                                                                     {{--srcset="https://aidspace.io/wp-content/uploads/2018/10/events-2-1024x621.png 1024w, https://aidspace.io/wp-content/uploads/2018/10/events-2-300x182.png 300w, https://aidspace.io/wp-content/uploads/2018/10/events-2-768x466.png 768w, https://aidspace.io/wp-content/uploads/2018/10/events-2-600x364.png 600w"--}}
                                                                                     {{--sizes="(max-width: 1024px) 100vw, 1024px"/>--}}
                                                                            {{--</div>--}}
                                                                        {{--</figure>--}}
                                                                    {{--</div>--}}
                                                                    ...
                                                                    {{--<div--}}
                                                                        ...
                                                                        {{--<div class="wpb_wrapper">--}}
                                                                            {{--<p><span--}}
                                                                                    {{--style="font-weight: 400;">and Month</span>--}}
                                                                            {{--</p>--}}
                                                                        ...
                                                                        {{--<figure class="wpb_wrapper vc_figure">--}}
                                                                            {{--<div--}}
                                                                                ...
                                                                                {{--<img width="1024" height="513"--}}
                                                                                     ...
                                                                                     {{--srcset="https://aidspace.io/wp-content/uploads/2018/10/events-3-1024x513.png 1024w, https://aidspace.io/wp-content/uploads/2018/10/events-3-300x150.png 300w, https://aidspace.io/wp-content/uploads/2018/10/events-3-768x385.png 768w, https://aidspace.io/wp-content/uploads/2018/10/events-3-600x301.png 600w"--}}
                                                                                     {{--sizes="(max-width: 1024px) 100vw, 1024px"/>--}}
                                                                            {{--</div>--}}
                                                                        {{--</figure>--}}
                                                                    {{--</div>--}}
                                                                    ...
                                                                    {{--<div--}}
                                                                        {{--class="wpb_text_column wpb_content_element ">--}}
                                                                        {{--<div class="wpb_wrapper">--}}
                                                                            {{--<p><span style="font-weight: 400;">2. Option to export in iCal in each view. </span>--}}
                                                                            {{--</p>--}}
                                                                            {{--<p><span style="font-weight: 400;">3. Create new event in each view. </span>--}}
                                                                            {{--</p>--}}
                                                                            {{--<ul>--}}
                                                                                {{--<li style="font-weight: 400;"><span--}}
                                                                                        {{--style="font-weight: 400;">Press “+” button and fill the details in the pop up window. Click “Save”.</span>--}}
                                                                                {{--</li>--}}
                                                                                {{--<li style="font-weight: 400;"><span--}}
                                                                                        {{--style="font-weight: 400;">Once you save the event it will be visible to all users.</span>--}}
                                                                                {{--</li>--}}
                                                                            {{--</ul>--}}
                                                                        ...
                                                                        {{--<figure class="wpb_wrapper vc_figure">--}}
                                                                            {{--<div--}}
                                                                                ...
                                                                                {{--<img width="1024" height="482"--}}
                                                                                     ...
                                                                                     {{--srcset="https://aidspace.io/wp-content/uploads/2018/10/events-4-1024x482.png 1024w, https://aidspace.io/wp-content/uploads/2018/10/events-4-300x141.png 300w, https://aidspace.io/wp-content/uploads/2018/10/events-4-768x362.png 768w, https://aidspace.io/wp-content/uploads/2018/10/events-4-600x283.png 600w"--}}
                                                                                     {{--sizes="(max-width: 1024px) 100vw, 1024px"/>--}}
                                                                            {{--</div>--}}
                                                                        {{--</figure>--}}
                                                                    {{--</div>--}}
                                                            ...
                                                            {{--</div>--}}
                                                            {{--<div class="vc_tta-panel"--}}
                                                                 {{--id="1539326426041-3c931806-1a07"--}}
                                                                 {{--data-vc-content=".vc_tta-panel-body">--}}
                                                                {{--<div class="vc_tta-panel-heading"><h4--}}
                                                                        {{--class="vc_tta-panel-title"><a--}}
                                                                            {{--href="#1539326426041-3c931806-1a07"--}}
                                                                            {{--data-vc-accordion--}}
                                                                            {{--data-vc-container=".vc_tta-container"><span--}}
                                                                                {{--class="vc_tta-title-text">Settings</span></a>--}}
                                                                    {{--</h4></div>--}}
                                                                {{--<div class="vc_tta-panel-body">--}}
                                                                    {{--<div--}}
                                                                        {{--class="wpb_text_column wpb_content_element ">--}}
                                                                        {{--<div class="wpb_wrapper">--}}
                                                                            {{--<p><span style="font-weight: 400;">1. General. Set your timezone here:</span>--}}
                                                                            {{--</p>--}}
                                                                    ...
                                                                    {{--<div--}}
                                                                        {{--class="wpb_text_column wpb_content_element ">--}}
                                                                        {{--<div class="wpb_wrapper">--}}
                                                                            {{--<p><span style="font-weight: 400;">2. Groups. </span>--}}
                                                                            {{--</p>--}}
                                                                    ...
                                                                    {{--<div--}}
                                                                        ...
                                                                        {{--<div class="wpb_wrapper">--}}
                                                                            {{--<ul>--}}
                                                                                {{--<li><span style="font-weight: 400;">Create.</span>--}}
                                                                                {{--</li>--}}
                                                                            {{--</ul>--}}
                                                                    ...
                                                                    {{--<div--}}
                                                                        ...
                                                                        {{--<div class="wpb_wrapper">--}}
                                                                            {{--<ul>--}}
                                                                                {{--<li><span style="font-weight: 400;">Edit &#8211; click on the group and edit its name or </span><span--}}
                                                                                        {{--style="font-weight: 400;">Delete &#8211; click on the group and click on the additional options menu</span><span--}}
                                                                                        {{--style="font-weight: 400;"> choose delete and confirm. </span>--}}
                                                                                {{--</li>--}}
                                                                            {{--</ul>--}}
                                                                    ...
                                                                    {{--<div--}}
                                                                        ...
                                                                        {{--<div class="wpb_wrapper">--}}
                                                                            {{--<p><span--}}
                                                                                    {{--style="font-weight: 400;">3. Areas.</span>--}}
                                                                            {{--</p>--}}
                                                                            {{--<ul>--}}
                                                                                {{--<li style="font-weight: 400;"><span--}}
                                                                                        {{--style="font-weight: 400;">Create</span>--}}
                                                                                {{--</li>--}}
                                                                            {{--</ul>--}}
                                                                    ...
                                                                    {{--<div--}}
                                                                        ...
                                                                        {{--<div class="wpb_wrapper">--}}
                                                                            {{--<ul>--}}
                                                                                {{--<li style="font-weight: 400;"><span--}}
                                                                                        {{--style="font-weight: 400;">Edit  click on the area and edit its name </span>--}}
                                                                                {{--</li>--}}
                                                                                {{--<li style="font-weight: 400;"><span--}}
                                                                                        {{--style="font-weight: 400;">Delete click on the area and click on the additional options menu </span><span--}}
                                                                                        {{--style="font-weight: 400;">choose delete and confirm.</span>--}}
                                                                                {{--</li>--}}
                                                                            {{--</ul>--}}
                                                                        ...
                                                                        {{--<figure class="wpb_wrapper vc_figure">--}}
                                                                            {{--<div--}}
                                                                                ...
                                                                                {{--<img width="786" height="192"--}}
                                                                                     {{--src="{{ asset('images/settings-8-areas.png') }}"--}}
                                                                                     {{--class="vc_single_image-img attachment-large"--}}
                                                                                     {{--alt="Volunteer coordinator, edit area"--}}
                                                                    ...
                                                                    {{--<div--}}
                                                                        {{--class="wpb_text_column wpb_content_element ">--}}
                                                                        {{--<div class="wpb_wrapper">--}}
                                                                            {{--<p><span style="font-weight: 400;">4. Users. Manage your users and their roles.</span>--}}
                                                                            {{--</p>--}}
                                                                    ...
                                                                    {{--<div--}}
                                                                        ...
                                                                        {{--<div class="wpb_wrapper">--}}
                                                                            {{--<ul>--}}
                                                                                {{--<li><span style="font-weight: 400;">Create users by clicking “+” button.</span>--}}
                                                                                {{--</li>--}}
                                                                                {{--<li style="font-weight: 400;"><span--}}
                                                                                        {{--style="font-weight: 400;">Create more coordinators or add new administrators</span>--}}
                                                                                {{--</li>--}}
                                                                                {{--<li style="font-weight: 400;"><span--}}
                                                                                        {{--style="font-weight: 400;">Set their preferences &#8211; chose their groups and areas and if they should see all volunteers or only the ones who belong to their groups and areas.</span>--}}
                                                                                {{--</li>--}}
                                                                            {{--</ul>--}}
                                                                    ...
                                                                    {{--<div--}}
                                                                        ...
                                                                        {{--<div class="wpb_wrapper">--}}
                                                                            {{--<ul>--}}
                                                                                {{--<li style="font-weight: 400;"><span--}}
                                                                                        {{--style="font-weight: 400;">Edit users.</span>--}}
                                                                                    {{--<ul>--}}
                                                                                        {{--<li style="font-weight: 400;">--}}
                                                                                                {{--<span--}}
                                                                                                    {{--style="font-weight: 400;">Click on the field in grey background while scroll and edt the user profile. </span>--}}
                                                                                        {{--</li>--}}
                                                                                    {{--</ul>--}}
                                                                                {{--</li>--}}
                                                                                {{--<li style="font-weight: 400;"><span--}}
                                                                                        {{--style="font-weight: 400;">Delete users.</span>--}}
                                                                                {{--</li>--}}
                                                                            {{--</ul>--}}
                                                                    ...
                                                                    {{--<div--}}
                                                                        {{--class="wpb_text_column wpb_content_element ">--}}
                                                                        {{--<div class="wpb_wrapper">--}}
                                                                            {{--<p><span style="font-weight: 400;">5. Export. </span>--}}
                                                                            {{--</p>--}}
                                                                            {{--<ul>--}}
                                                                                {{--<li><span style="font-weight: 400;">Export all of your data. </span>--}}
                                                                                {{--</li>--}}
                                                                            {{--</ul>--}}
                                                                            {{--<p><span style="font-weight: 400;">6. Change log. </span>--}}
                                                                            {{--</p>--}}
                                                                            {{--<ul>--}}
                                                                                {{--<li style="font-weight: 400;"><span--}}
                                                                                        {{--style="font-weight: 400;">Follow through the changes and actions you performed. </span>--}}
                                                                                {{--</li>--}}
                                                                                {{--<li style="font-weight: 400;"><span--}}
                                                                                        {{--style="font-weight: 400;">Access the old data and compare to the new entry. </span>--}}
                                                                                {{--</li>--}}
                                                                                {{--<li style="font-weight: 400;"><span--}}
                                                                                        {{--style="font-weight: 400;">Follow up when you made the changes.</span>--}}
                                                                                {{--</li>--}}
                                                                            {{--</ul>--}}
                                ...
                                {{--</div>--}}
                            {{--</div>--}}
                            {{--<div class="vc_row wpb_row vc_row-fluid vc_custom_1540724246631">--}}
                                {{--<div class="wpb_column vc_column_container vc_col-sm-12">--}}
                                    {{--<div class="vc_column-inner ">--}}
                                        {{--<div class="wpb_wrapper">--}}
                                            {{--<div--}}
                                                ...
                                                {{--<div class="wpb_wrapper">--}}
                                                    {{--<h3 style="text-align: center;"><strong><span--}}
                                                                {{--style="text-decoration: underline;">Volunteers</span></strong>--}}
                                                    {{--</h3>--}}
                                            ...
                                            {{--<div class="vc_tta-container" data-vc-action="collapse">--}}
                                                {{--<div--}}
                                                    ...
                                                    {{--<div class="vc_tta-tabs-container">--}}
                                                        {{--<ul class="vc_tta-tabs-list">--}}
                                                            {{--<li class="vc_tta-tab vc_active" data-vc-tab><a--}}
                                                                    {{--href="#1540291815753-a3c834ed-3f58" data-vc-tabs--}}
                                                                    {{--data-vc-container=".vc_tta"><span--}}
                                                                        {{--class="vc_tta-title-text">Dashboard</span></a>--}}
                                                            {{--</li>--}}
                                                            {{--<li class="vc_tta-tab" data-vc-tab><a--}}
                                                                    {{--href="#1540291814881-9da7ce97-f4ba" data-vc-tabs--}}
                                                                    {{--data-vc-container=".vc_tta"><span--}}
                                                                        {{--class="vc_tta-title-text">My profile</span></a>--}}
                                                            {{--</li>--}}
                                                            {{--<li class="vc_tta-tab" data-vc-tab><a--}}
                                                                    {{--href="#1540291816769-433abedb-eac9" data-vc-tabs--}}
                                                                    {{--data-vc-container=".vc_tta"><span--}}
                                                                        {{--class="vc_tta-title-text">Messages</span></a>--}}
                                                            {{--</li>--}}
                                                            {{--<li class="vc_tta-tab" data-vc-tab><a--}}
                                                                    {{--href="#1540291819401-1305007a-b84f" data-vc-tabs--}}
                                                                    {{--data-vc-container=".vc_tta"><span--}}
                                                                        {{--class="vc_tta-title-text">My Schedule</span></a>--}}
                                                            {{--</li>--}}
                                                            {{--<li class="vc_tta-tab" data-vc-tab><a--}}
                                                                    {{--href="#1540291820611-3cc607c3-b97d" data-vc-tabs--}}
                                                                    {{--data-vc-container=".vc_tta"><span--}}
                                                                        {{--class="vc_tta-title-text">Events</span></a>--}}
                                                            {{--</li>--}}
                                                        {{--</ul>--}}
                                                    ...
                                                    {{--<div class="vc_tta-panels-container">--}}
                                                        {{--<div class="vc_tta-panels">--}}
                                                            {{--<div class="vc_tta-panel vc_active"--}}
                                                                 {{--id="1540291815753-a3c834ed-3f58"--}}
                                                                 {{--data-vc-content=".vc_tta-panel-body">--}}
                                                                {{--<div class="vc_tta-panel-heading"><h4--}}
                                                                        {{--class="vc_tta-panel-title"><a--}}
                                                                            {{--href="#1540291815753-a3c834ed-3f58"--}}
                                                                            {{--data-vc-accordion--}}
                                                                            {{--data-vc-container=".vc_tta-container"><span--}}
                                                                                {{--class="vc_tta-title-text">Dashboard</span></a>--}}
                                                                    {{--</h4></div>--}}
                                                                {{--<div class="vc_tta-panel-body">--}}
                                                                    {{--<div--}}
                                                                        {{--class="wpb_text_column wpb_content_element ">--}}
                                                                        {{--<div class="wpb_wrapper">--}}
                                                                            {{--<p><strong>Your way to communicate and--}}
                                                                                    {{--get--}}
                                                                                    {{--up-to-date information from your--}}
                                                                                    {{--coordinator and administrators.--}}
                                                                                    {{--Dashboard is the first page that--}}
                                                                                    {{--loads--}}
                                                                                    {{--on your screen once you log--}}
                                                                                    {{--in.</strong>--}}
                                                                            {{--</p>--}}
                                                                    ...
                                                                    {{--<div--}}
                                                                        ...
                                                                        {{--<figure class="wpb_wrapper vc_figure">--}}
                                                                            {{--<div--}}
                                                                                {{--class="vc_single_image-wrapper vc_box_shadow_3d  vc_box_border_grey">--}}
                                                                                {{--<img width="1024" height="508"--}}
                                                                                     {{--src="{{ asset('images/volunteer-dashboard-3-1024x508.png') }}"--}}
                                                                                     {{--class="vc_single_image-img attachment-large"--}}
                                                                                     {{--alt="Dasboard in volunteer profile"--}}
                                                            ...
                                                            {{--</div>--}}
                                                            {{--<div class="vc_tta-panel"--}}
                                                                 {{--id="1540291814881-9da7ce97-f4ba"--}}
                                                                 {{--data-vc-content=".vc_tta-panel-body">--}}
                                                                {{--<div class="vc_tta-panel-heading"><h4--}}
                                                                        {{--class="vc_tta-panel-title"><a--}}
                                                                            {{--href="#1540291814881-9da7ce97-f4ba"--}}
                                                                            {{--data-vc-accordion--}}
                                                                            {{--data-vc-container=".vc_tta-container"><span--}}
                                                                                {{--class="vc_tta-title-text">My profile</span></a>--}}
                                                                    {{--</h4></div>--}}
                                                                {{--<div class="vc_tta-panel-body">--}}
                                                                    ...
                                                                    {{--<div--}}
                                                                        {{--class="wpb_text_column wpb_content_element ">--}}
                                                                        {{--<div class="wpb_wrapper">--}}
                                                                            {{--<p><span style="font-weight: 400;">1. Profile tab. Manage your basic data here.</span>--}}
                                                                            {{--</p>--}}
                                                                            {{--<ul>--}}
                                                                                {{--<li style="font-weight: 400;"><span--}}
                                                                                        {{--style="font-weight: 400;">You can edit your profile picture by clicking on it. </span>--}}
                                                                                {{--</li>--}}
                                                                                {{--<li style="font-weight: 400;"><span--}}
                                                                                        {{--style="font-weight: 400;">Change your notification preferences and verify your contact details.</span>--}}
                                                                                {{--</li>--}}
                                                                            {{--</ul>--}}
                                                                    ...
                                                                    {{--<div--}}
                                                                        {{--class="wpb_text_column wpb_content_element ">--}}
                                                                        {{--<div class="wpb_wrapper">--}}
                                                                            {{--<p><span style="font-weight: 400;">2. Account tab. </span>--}}
                                                                            {{--</p>--}}
                                                                            {{--<ul>--}}
                                                                                {{--<li style="font-weight: 400;"><span--}}
                                                                                        {{--style="font-weight: 400;">Change your password</span>--}}
                                                                                {{--</li>--}}
                                                                                {{--<li style="font-weight: 400;"><span--}}
                                                                                        {{--style="font-weight: 400;">Or edit your email</span>--}}
                                                                                {{--</li>--}}
                                                                            {{--</ul>--}}
                                                                    ...
                                                                    {{--<div--}}
                                                                        {{--class="wpb_text_column wpb_content_element ">--}}
                                                                        {{--<div class="wpb_wrapper">--}}
                                                                            {{--<p><span style="font-weight: 400;">3. Availability tab. </span>--}}
                                                                            {{--</p>--}}
                                                                            {{--<ul>--}}
                                                                                {{--<li style="font-weight: 400;"><span--}}
                                                                                        {{--style="font-weight: 400;">Enter your availability &#8211; click “Add” button</span><span--}}
                                                                                        {{--style="font-weight: 400;"> click “Save” on the pop up and then “Save”on the initial pop up window. You can easily fix a wrongfully entered availability just using drag and drop.</span>--}}
                                                                                {{--</li>--}}
                                                                            {{--</ul>--}}
                                                            ...
                                                            {{--</div>--}}
                                                            {{--<div class="vc_tta-panel"--}}
                                                                 {{--id="1540291816769-433abedb-eac9"--}}
                                                                 {{--data-vc-content=".vc_tta-panel-body">--}}
                                                                {{--<div class="vc_tta-panel-heading"><h4--}}
                                                                        {{--class="vc_tta-panel-title"><a--}}
                                                                            {{--href="#1540291816769-433abedb-eac9"--}}
                                                                            {{--data-vc-accordion--}}
                                                                            {{--data-vc-container=".vc_tta-container"><span--}}
                                                                                {{--class="vc_tta-title-text">Messages</span></a>--}}
                                                                    {{--</h4></div>--}}
                                                                {{--<div class="vc_tta-panel-body">--}}
                                                                    ...
                                                                    {{--<div--}}
                                                                        {{--class="wpb_text_column wpb_content_element ">--}}
                                                                        {{--<div class="wpb_wrapper">--}}
                                                                            {{--<p><span style="font-weight: 400;">1. This is your inbox:</span>--}}
                                                                            {{--</p>--}}
                                                                    ...
                                                                    {{--<div--}}
                                                                        {{--class="wpb_text_column wpb_content_element ">--}}
                                                                        {{--<div class="wpb_wrapper">--}}
                                                                            {{--<p><span style="font-weight: 400;">2. Create new message. </span>--}}
                                                                            {{--</p>--}}
                                                                            {{--<ul>--}}
                                                                                {{--<li style="font-weight: 400;"><span--}}
                                                                                        {{--style="font-weight: 400;">Press “+” button. A pop up appears with many useful options. </span>--}}
                                                                                    {{--<ul>--}}
                                                                                        ...
                                                                                        {{--<li style="font-weight: 400;">--}}
                                                                                                {{--<span--}}
                                                                                                    {{--style="font-weight: 400;">Send a copy to your coordinator or fellow coordinators and administrators.</span>--}}
                                                                                        {{--</li>--}}
                                                                                    {{--</ul>--}}
                                                                                {{--</li>--}}
                                                                            {{--</ul>--}}
                                                                    ...
                                                                    {{--<div--}}
                                                                        ...
                                                                        {{--<figure class="wpb_wrapper vc_figure">--}}
                                                                            {{--<div--}}
                                                                                {{--class="vc_single_image-wrapper vc_box_shadow_3d  vc_box_border_grey">--}}
                                                                                {{--<img width="1024" height="691"--}}
                                                                                     {{--src="{{ asset('images/volunteers-messages-2-1024x691.png') }}"--}}
                                                                                     {{--class="vc_single_image-img attachment-large"--}}
                                                                                     {{--alt="Volunteer messging, messages module"--}}
                                                            ...
                                                            {{--</div>--}}
                                                            {{--<div class="vc_tta-panel"--}}
                                                                 {{--id="1540291819401-1305007a-b84f"--}}
                                                                 {{--data-vc-content=".vc_tta-panel-body">--}}
                                                                {{--<div class="vc_tta-panel-heading"><h4--}}
                                                                        {{--class="vc_tta-panel-title"><a--}}
                                                                            {{--href="#1540291819401-1305007a-b84f"--}}
                                                                            {{--data-vc-accordion--}}
                                                                            {{--data-vc-container=".vc_tta-container"><span--}}
                                                                                {{--class="vc_tta-title-text">My Schedule</span></a>--}}
                                                                    {{--</h4></div>--}}
                                                                {{--<div class="vc_tta-panel-body">--}}
                                                                    {{--<div--}}
                                                                        {{--class="wpb_text_column wpb_content_element ">--}}
                                                                        {{--<div class="wpb_wrapper">--}}
                                                                            {{--<p><strong>Your assignments in one place--}}
                                                                                    {{--&#8211; easy to grab and--}}
                                                                                    {{--reject.</strong></p>--}}
                                                                    ...
                                                                    {{--<div--}}
                                                                        ...
                                                                        {{--<div class="wpb_wrapper">--}}
                                                                            {{--<ol>--}}
                                                                                {{--<li><span style="font-weight: 400;">Three comfortable views for your convenience &#8211; List:</span><span--}}
                                                                                        {{--style="font-weight: 400;"> </span>--}}
                                                                                {{--</li>--}}
                                                                            {{--</ol>--}}
                                                                    ...
                                                                    {{--<div--}}
                                                                        ...
                                                                        {{--<div class="wpb_wrapper">--}}
                                                                            {{--<p><span--}}
                                                                                    {{--style="font-weight: 400;">Month</span><span--}}
                                                                                    {{--style="font-weight: 400;">:</span>--}}
                                                                            {{--</p>--}}
                                                                    ...
                                                                    {{--<div--}}
                                                                        {{--class="wpb_text_column wpb_content_element ">--}}
                                                                        {{--<div class="wpb_wrapper">--}}
                                                                            {{--<p><span style="font-weight: 400;">3. Apply for a shift.</span>--}}
                                                                            {{--</p>--}}
                                                                    ...
                                                                    {{--<div--}}
                                                                        {{--class="wpb_text_column wpb_content_element ">--}}
                                                                        {{--<div class="wpb_wrapper">--}}
                                                                            {{--<p><span style="font-weight: 400;">4. Or reject a shift.</span>--}}
                                                                            {{--</p>--}}
                                                            ...
                                                            {{--</div>--}}
                                                            {{--<div class="vc_tta-panel"--}}
                                                                 {{--id="1540291820611-3cc607c3-b97d"--}}
                                                                 {{--data-vc-content=".vc_tta-panel-body">--}}
                                                                {{--<div class="vc_tta-panel-heading"><h4--}}
                                                                        {{--class="vc_tta-panel-title"><a--}}
                                                                            {{--href="#1540291820611-3cc607c3-b97d"--}}
                                                                            {{--data-vc-accordion--}}
                                                                            {{--data-vc-container=".vc_tta-container"><span--}}
                                                                                {{--class="vc_tta-title-text">Events</span></a>--}}
                                                                    {{--</h4>--}}
                                                                ...
                                                                {{--<div class="vc_tta-panel-body">--}}
                                                                    {{--<div--}}
                                                                        {{--class="wpb_text_column wpb_content_element ">--}}
                                                                        {{--<div class="wpb_wrapper">--}}
                                                                            {{--<p><strong>Know the upcoming events in--}}
                                                                                    {{--the--}}
                                                                                    {{--organisation by following the--}}
                                                                                    {{--Events--}}
                                                                                    {{--calendar.</strong>--}}
                                                                            {{--</p>--}}
                                                                        {{--</div>--}}
                                                                    ...
                                                                    {{--<div--}}
                                                                        {{--class="wpb_text_column wpb_content_element ">--}}
                                                                        {{--<div class="wpb_wrapper">--}}
                                                                            {{--<p><span style="font-weight: 400;">and Month:</span>--}}
                                                                            {{--</p>--}}
                                                                        ...
                                                                        {{--<figure class="wpb_wrapper vc_figure">--}}
                                                                            {{--<div--}}
                                                                                ...
                                                                                {{--<img width="1024" height="448"--}}
                                                                                     {{--src="{{ asset('images/volunteer-events-3-1024x448.png') }}"--}}
                                                                                     {{--class="vc_single_image-img attachment-large"--}}
                                                                                     {{--alt="Events, events module month view"--}}
